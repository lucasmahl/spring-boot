...
@Configuration
@Profile("test") // nome tem q ser igual ao do profile do application.properties
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1); // pagamento efetuado 2h após o
																						// pedido
		o1.setPayment(pay1);
